...
- Portend how much RAM to allocate automatically based on available system resources using ```source_ram()``` or ```source_ram(only_free=TRUE)``` or ```source_ram(percent_of_total=20)```
